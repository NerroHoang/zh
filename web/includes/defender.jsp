<%-- 
    Document   : defender
    Created on : Mar 18, 2024, 1:54:09 AM
    Author     : hoang
--%>
            ...
            <div class="about">
                ...
                <div class="search">
                    ...
                    <a class="button" href="home.jsp" >POPULAR</a>                        
                        <a class="button" href="home-goalkeeper.jsp" >GOALKEEPERS</a>
                        <a class="button chosse" href="home-defender.jsp" >DEFENDERS</a>
                ...
                <div class="list">
                    ...
                    <%
                        ArrayList<Player> players = DB.getDefenders();
